...
PADDLE_DEFINE_EXPORTED_int32(record_pool_max_size,
             2000000,
             "SlotRecordDataset slot record pool max size");
PADDLE_DEFINE_EXPORTED_int32(slotpool_thread_num, 1, "SlotRecordDataset slot pool thread num");
PADDLE_DEFINE_EXPORTED_bool(enable_slotpool_wait_release,
            false,
            "enable slotrecord obejct wait release, default false");
PADDLE_DEFINE_EXPORTED_bool(enable_slotrecord_reset_shrink,
            false,
            "enable slotrecord obejct reset shrink memory, default false");
PADDLE_DEFINE_EXPORTED_bool(enable_ins_parser_file,
            false,
...
PADDLE_DEFINE_EXPORTED_bool(enable_dense_nccl_barrier, false,
            "enable dense nccl barrier , default false");
PADDLE_DEFINE_EXPORTED_bool(enable_pullpush_dedup_keys, true,
            "enable pull push dedup keys, default false");
PADDLE_DEFINE_EXPORTED_bool(enable_shuffle_by_searchid, false,
            "enable dualbox shuffle by searchid, default false");
PADDLE_DEFINE_EXPORTED_bool(enable_pull_box_padding_zero, true,
            "enable pull box padding zero, default true");
PADDLE_DEFINE_EXPORTED_bool(enbale_slotpool_auto_clear, false,
